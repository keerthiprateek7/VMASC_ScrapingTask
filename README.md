...
### Can also use: Screener

It is a private company that maintains database for companies and their stock symbols. They also provide historical data which can be used for analysis and stock prediction.
